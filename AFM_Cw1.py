...
num_paths_list = [400, 1000, 1500, 2000, 3000, 4500, 6000, 12000]
# num_paths_list = [20000, 40000, 80000, 160000, 400000]
option_prices_list = []
...
plt.title("Monte Carlo Call Option Price vs. Number of Paths with 95% Confidence Intervals")
